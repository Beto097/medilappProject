                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">                                    
                                        ...
                                        <textarea class="form-control is-invalid" id="exampleFormControlTextarea1" style="border-color: red"
                                                placeholder="" name="txtAlergias" rows="3" autocomplete="off">{{$paciente->alergias}}</textarea>                                        
                                    </div>

                                    <div class="col-md-6 col-sm-12 col-xs-12">                                    
                                        <label class="control-label text-danger text-left">Atecedente Personales(APP)</label>
                                        <textarea class="form-control is-invalid" id="exampleFormControlTextarea1" style="border-color: red"
                                                placeholder="" name="txtMedicamentos" rows="3" autocomplete="off">{{$paciente->medicinas}}</textarea>                                        
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">                                    
                                        <label class="control-label text-left">Historia Clinica</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                                placeholder="" name="txtHistoriaClinica" rows="3" autocomplete="off">{{$consulta->historia_clinica}}</textarea>                                        
                                    </div> 
                                    <div class="col-md-8 col-sm-12 col-xs-12">                                    
                                        <label class="control-label text-left">Examen Fisico</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                                placeholder="" name="txtExamenFisico" rows="5" autocomplete="off">{{$consulta->examen_fisico}}</textarea>                                        
                                    </div> 
                                    <div class="col-md-4 col-sm-12 col-xs-12">  
                                        <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">                                    
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                                placeholder="" name="txtLaboratoriosExamenes" rows="3" autocomplete="off">{{$consulta->laboratorios_examenes}}</textarea>                                        
                                    </div>
                                    <div class="col-md-12 col-sm-6 col-xs-6">                                    
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">                                    
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                                placeholder="" name="txtRecomendaciones" rows="3" autocomplete="off">{{$consulta->recomendaciones}}</textarea>                                        
                                    </div> 
