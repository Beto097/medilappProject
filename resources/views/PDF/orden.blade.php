  ...
  <body background="images/ValmarHojaMembretada2.png">
    ...
    <table style="width: 100%";>
        <tr>
            <td style="text-align: left"?>
                <img src="{{Auth::user()->company->imagen}}" width="200"/>
                <td style="text-align: right" width="550px">
                    ...
                    <p id="subClinica" style="text-align: center; padding-top:1rem;">
    ...
    <table class="table justify-content-center">
        <thead>
            <tr>
                <td>
                    <p id="titulo">Nombre de Examen</p>
                </td>
                <td>
                    <p id="titulo">Estado</p>
                </td>
            </tr>
        </thead>
        <tbody>
           ...
           @foreach ($orden->examenes as $index1 => $examen )
